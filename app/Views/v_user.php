                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <?php } elseif ($value['level'] == 2) { ?>
                                                    <span class="badge bg-primary">Panitia Seleksi</span>
                                                <?php } elseif ($value['level'] == 3) { ?>
                                                    <span class="badge bg-warning text-dark">Calon Penerima</span>
                                                <?php } else { ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="level" class="form-control">
                            ...
                            <option value="2">Panitia Seleksi</option>
                            <option value="3">Calon Penerima</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="level" class="form-control">
                            ...
                            <option value="2" <?= $value['level'] == 2 ? 'Selected' : '' ?>>Panitia Seleksi</option>
                            <option value="3" <?= $value['level'] == 3 ? 'Selected' : '' ?>>Calon Penerima</option>
                        </select>
                    </div>
